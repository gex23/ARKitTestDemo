...
//// this to convert location wiht long &&& lat to x,y,z of object in screen.
...
class MatrixHelper {
    ...
    static func transformMatrix(for matrix: simd_float4x4, originLocation: CLLocation, location: CLLocation) -> simd_float4x4 {
        ...
        //let distance = Float(location.distance(from: originLocation)) * 100
        let distance = Float(location.distance(from: originLocation)) * 1000
